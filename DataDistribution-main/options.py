...
def args_parser():
    ...
    parser.add_argument('--frequency_vicious', type=int, default=20, help="the number of data distribution probes")
    ...
    parser.add_argument('--data_size', type=int, default=6000, help="number of datasets number")
    ...
    parser.add_argument('--seed', type=int, default=182, help='random seed (default: 1)')
    parser.add_argument('--all_clients', action='store_true', help='aggregation over all clients')
    parser.add_argument('--device', type=str, default='cpu', help='CPU/CUDA device option')
    parser.add_argument('--is_federated', type=bool, default=False, help='single or federated learning training')
